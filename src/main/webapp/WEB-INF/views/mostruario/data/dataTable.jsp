...
<html>
	...
	<body>
        	...
        	<div class="container-fluid">
        		<div class="row">
        			<div class="col-md-3">
          			...
          			<div class="col-md-9">          				
          				<h1>Input - DataTable</h1>
          				<p class="text-justify">DataTable</p>
          				<h5>Powered by: <a href="https://datatables.net/" target="_blank" title="DataTables">DataTables</a></h5>          			
          				<hr>          				
		...
		<script src="<c:url value="/resources/layout/js/plugins/jquery.dataTables.min.js" />" type="text/javascript"></script>
		<script src="<c:url value="/resources/layout/js/plugins/jquery.dataTables/dataTables.bootstrap4.min.js" />" type="text/javascript"></script>
